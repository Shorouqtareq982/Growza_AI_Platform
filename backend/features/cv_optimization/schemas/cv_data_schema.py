...
class Project(BaseModel):
    ...
    resources: Optional[List[Link]] = Field(None,description="Additional resources related to the project, such as documentation, slides, or videos.")
...
class Media(BaseModel):
    ...
    devpost: Optional[str] = Field(None,description="Devpost profile URL")
